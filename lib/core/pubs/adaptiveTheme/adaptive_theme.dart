...
class _AdaptiveThemeState extends State<AdaptiveTheme>
  ...
  ThemeData get theme {
    if (_preferences.mode.isSystem) {
      ...
      SharedStore.setThemeBrightness(brightness == Brightness.light ? 1 : 0);
      return brightness == Brightness.light ? _theme : _darkTheme;
    }
    SharedStore.setThemeBrightness(!_preferences.mode.isDark ? 1 : 0);
  ...
  void toggleThemeMode() {
    ...
    switch(nextMode){
      case AdaptiveThemeMode.light:
        AppSnackBar.showToast("light");
        SharedStore.setTheme("light");
        break;
      case AdaptiveThemeMode.dark:
        AppSnackBar.showToast("dark");
        SharedStore.setTheme("dark");
        break;
      case AdaptiveThemeMode.system:
        AppSnackBar.showToast("system");
        SharedStore.setTheme("system");
        break;
    }
