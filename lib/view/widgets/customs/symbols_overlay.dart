...
import 'package:flutter_web3_games/view/widgets/customs/scroll_offset.dart';

enum SymbolsOverlayType {
  circleAndTriangle(
    asset: 'assets/images/symbols_1.png',
    alignment: Alignment.topLeft,
  ),
  rectangleAndCross(
    asset: 'assets/images/symbols_2.png',
...
class SymbolsOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final side = context.isHorizontalScreen() ? data.size.width * 0.4 : data.size.width * 0.25;
