...
class RockPaperPageOnline extends StatefulWidget {

  const RockPaperPageOnline({Key? key}) : super(key: key);

  @override
  State createState() => _RockPaperPageOnlineState();

}

class _RockPaperPageOnlineState extends State<RockPaperPageOnline> {
